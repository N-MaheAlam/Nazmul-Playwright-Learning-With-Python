...
def test_pop_up_alerts(page: Page):
    ...
    # so our test is alert and once we click it grabs the pop-up and follow the instructions. Its like
    # telling security guard " please watch the door if anyone is outside or not. Security is alert, and you
    # proceed to open the door". If I put click() first, its like I opened the door without checking
    # outside and telling the security to let me inform which is a security risk right?.
